...
https://docs.djangoproject.# DRF-YASG specific settings for public access
SWAGGER_SETTINGS = {
...
# Use Supabase PostgreSQL if DATABASE_URL is provided, otherwise SQLite for development
...
# Static file finders (important for drf-yasg)
STATICFILES_FINDERS = [
